...
Usage (from workspace root):
  ...
  RESUME_DIR=path/to/resumes python -m projects.meridian.scripts.build_training_data
...
if not OUTPUT_PATH:
    OUTPUT_PATH = os.path.join(WORKSPACE_ROOT, "projects", "meridian", "prompts", "training_data.json")
