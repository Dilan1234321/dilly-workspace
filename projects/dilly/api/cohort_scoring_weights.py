...
COHORT_SCORING_WEIGHTS: dict[str, dict] = {
    ...
    # ─────────────────────────────────────────────────────────────────────
    # EXTENDED COHORTS — all ALL_COHORTS entries not covered above.
    # These cover interest/exploratory cohorts that students can select
    # in the InterestsPicker. Weights are calibrated to field norms.
    # ─────────────────────────────────────────────────────────────────────

    "industrial_systems_engineering": {
        "label": "Industrial & Systems Engineering",
        "smart": 30, "grit": 32, "build": 38,
        "recruiter_bar": 74,
        "reference_benchmark": "Amazon/UPS/GE Operations entry-level bar",
        "reference_company": "Amazon",
        "competition_level": "moderate",
    },
    "nursing_patient_care": {
        "label": "Nursing & Patient Care",
        "smart": 25, "grit": 48, "build": 27,
        "recruiter_bar": 74,
        "reference_benchmark": "Top hospital system nursing bar",
        "reference_company": "Mayo Clinic",
        "competition_level": "moderate",
    },
    "dental_oral_health": {
        "label": "Dental & Oral Health",
        "smart": 38, "grit": 38, "build": 24,
        "recruiter_bar": 78,
        "reference_benchmark": "Dental school admission / DSO entry bar",
        "reference_company": "Aspen Dental",
        "competition_level": "high",
    },
    "pharmacy_pharmaceutical_science": {
        "label": "Pharmacy & Pharmaceutical Science",
        "smart": 38, "grit": 35, "build": 27,
        "recruiter_bar": 76,
        "reference_benchmark": "CVS/Walgreens/retail pharmacy entry bar",
        "reference_company": "CVS Health",
        "competition_level": "moderate",
    },
    "veterinary_animal_science": {
        "label": "Veterinary & Animal Science",
        "smart": 35, "grit": 40, "build": 25,
        "recruiter_bar": 74,
        "reference_benchmark": "Vet school admission / animal health industry bar",
        "reference_company": "Banfield Pet Hospital",
        "competition_level": "moderate",
    },
    "performing_arts_film": {
        "label": "Performing Arts & Film",
        "smart": 12, "grit": 28, "build": 60,
        "recruiter_bar": 76,
        "reference_benchmark": "Major studio / conservatory / agency entry bar",
        "reference_company": "CAA",
        "competition_level": "very_high",
    },
    "criminal_justice_public_safety": {
        "label": "Criminal Justice & Public Safety",
        "smart": 28, "grit": 42, "build": 30,
        "recruiter_bar": 72,
        "reference_benchmark": "Federal agency / major city PD bar",
        "reference_company": "FBI",
        "competition_level": "moderate",
    },
    "public_administration_government": {
        "label": "Public Administration & Government",
        "smart": 35, "grit": 38, "build": 27,
        "recruiter_bar": 72,
        "reference_benchmark": "Presidential Management Fellows / city management bar",
        "reference_company": "U.S. Federal Government",
        "competition_level": "moderate",
    },
    "human_resources_people": {
        "label": "Human Resources & People",
        "smart": 22, "grit": 42, "build": 36,
        "recruiter_bar": 72,
        "reference_benchmark": "Fortune 500 HR generalist / SHRM entry bar",
        "reference_company": "Workday",
        "competition_level": "moderate",
    },
    "religious_studies_ministry": {
        "label": "Religious Studies & Ministry",
        "smart": 30, "grit": 48, "build": 22,
        "recruiter_bar": 68,
        "reference_benchmark": "Seminary / nonprofit faith org bar",
        "reference_company": "non-profit faith organizations",
        "competition_level": "low",
    },
    "supply_chain_logistics": {
        "label": "Supply Chain & Logistics",
        "smart": 28, "grit": 34, "build": 38,
        "recruiter_bar": 74,
        "reference_benchmark": "Amazon/FedEx/UPS supply chain entry bar",
        "reference_company": "Amazon",
        "competition_level": "moderate",
    },
    "real_estate_construction": {
        "label": "Real Estate & Construction",
        "smart": 25, "grit": 38, "build": 37,
        "recruiter_bar": 74,
        "reference_benchmark": "CBRE/JLL/top developer entry bar",
        "reference_company": "CBRE",
        "competition_level": "moderate",
    },
    "culinary_arts_food_service": {
        "label": "Culinary Arts & Food Service",
        "smart": 15, "grit": 38, "build": 47,
        "recruiter_bar": 72,
        "reference_benchmark": "Michelin-level restaurant / major hospitality brand bar",
        "reference_company": "Marriott",
        "competition_level": "moderate",
    },
    "hospitality_events": {
        "label": "Hospitality & Events",
        "smart": 18, "grit": 38, "build": 44,
        "recruiter_bar": 72,
        "reference_benchmark": "Marriott/Hyatt/top event agency entry bar",
        "reference_company": "Marriott",
        "competition_level": "moderate",
    },
    "agriculture_food_science": {
        "label": "Agriculture & Food Science",
        "smart": 30, "grit": 38, "build": 32,
        "recruiter_bar": 72,
        "reference_benchmark": "Cargill/ADM/USDA entry bar",
        "reference_company": "Cargill",
        "competition_level": "moderate",
    },
    "architecture_urban_planning": {
        "label": "Architecture & Urban Planning",
        "smart": 28, "grit": 32, "build": 40,
        "recruiter_bar": 76,
        "reference_benchmark": "Gensler/SOM/top urban planning firm bar",
    ...
    "aviation_transportation": {
        ...
        "smart": 35, "grit": 38, "build": 27,
        "recruiter_bar": 74,
        "reference_benchmark": "Major airline / Boeing / FAA entry bar",
        "reference_company": "Boeing",
        "competition_level": "moderate",
    },
    "fashion_apparel": {
        "label": "Fashion & Apparel",
        "smart": 18, "grit": 30, "build": 52,
        "recruiter_bar": 76,
        "reference_benchmark": "LVMH / Nordstrom / major fashion house bar",
        "reference_company": "LVMH",
        "competition_level": "high",
    },
    "foreign_languages_linguistics": {
        "label": "Foreign Languages & Linguistics",
        "smart": 40, "grit": 38, "build": 22,
        "recruiter_bar": 72,
        "reference_benchmark": "State Dept / translation agency / international NGO bar",
        "reference_company": "U.S. State Department",
        "competition_level": "moderate",
    },
    "journalism_broadcasting": {
        "label": "Journalism & Broadcasting",
        "smart": 28, "grit": 35, "build": 37,
        "recruiter_bar": 74,
        "reference_benchmark": "NYT / AP / major broadcast outlet bar",
        "reference_company": "The New York Times",
        "competition_level": "high",
    },
    "library_information_science": {
        ...
        "smart": 35, "grit": 38, "build": 27,
        "recruiter_bar": 68,
        "reference_benchmark": "Research library / archives / info science bar",
        "reference_company": "Library of Congress",
        "competition_level": "low",
    },
    "environmental_sustainability": {
        "label": "Environmental & Sustainability",
        "smart": 32, "grit": 35, "build": 33,
        "recruiter_bar": 74,
        "reference_benchmark": "EPA / sustainability consulting / clean energy bar",
...
# ─── Field Keywords ───────────────────────────────────────────────────────────
# Per-cohort keyword lists used by profile.py's field-fit scoring engine.
# When computing scores for INTEREST cohorts (cohorts the user is exploring but
# hasn't studied/worked in), the user's audit corpus (evidence_quotes +
# skill_tags) is scanned for these keywords. More matches = higher field-fit
# factor, meaning the user's profile actually demonstrates relevant experience
# in this field. Zero matches = base-rate scores (0.35 Smart, 0.60 Grit,
# 0.25 Build) rather than inflated SWE/CS scores applied to Architecture bars.
#
# Guidelines:
#   • Use 10–18 terms per cohort — a mix of single keywords and short phrases
#   • Single-word terms are fine for tech/STEM where vocabulary is distinctive
#   • A primary-cohort student should naturally match ≥40% of their cohort's
#     keywords from normal resume language; a complete outsider should match <20%
#   • Include both academic (coursework) and professional (job title/tool) terms

COHORT_FIELD_KEYWORDS: dict[str, list[str]] = {

    # ── Tech & Engineering ────────────────────────────────────────────────────
    "Software Engineering & CS": [
        # Languages — no "java" standalone (substring matches "javascript")
        "python", "javascript", "typescript",
        # Role identity — "engineer" matches "engineering intern", "developer"
        "engineer", "developer", "software", "programming",
        # Artifacts / practice
        "deployed", "api", "backend", "frontend",
        "html", "algorithm", "github", "codebase",
    ],
    "Data Science & Analytics": [
        # Core domain
        "data science", "machine learning", "python", "sql",
        # Techniques — "model" matches "machine learning model"
        "statistics", "model", "analysis", "regression",
        # Tools & workflow
        "tableau", "pandas", "numpy", "jupyter",
        # Broader data terms — "data" appears in any DS resume
        "dataset", "analytics", "data",
    ],
    "Cybersecurity & IT": [
        # Role identity
        "cybersecurity", "security analyst", "it support",
        # Tools & platforms
        "nmap", "wireshark", "kali", "splunk", "siem",
        # Techniques & artifacts
        "penetration testing", "vulnerability", "firewall", "encryption",
        "incident response", "ctf", "malware", "bash scripting",
        # Domain terms — "network" catches "networking" and "network admin"
        "network", "linux",
    ],
    "Mechanical & Aerospace Engineering": [
        # Role identity — "mechanical" catches "mechanical engineering"
        "mechanical", "aerospace", "propulsion",
        # CAD / simulation tools
        "solidworks", "autocad", "catia", "ansys", "matlab",
        # Techniques & coursework
        "fluid dynamics", "thermodynamic", "finite element", "heat transfer",
        "statics", "dynamics", "manufacturing", "tolerance",
        # Artifacts
        "cad model", "stress analysis", "prototype",
    ],
    "Electrical & Computer Engineering": [
        # Role identity — "electrical" catches "electrical engineering"
        "electrical", "ece",
        # Tools & platforms
        "fpga", "arduino", "raspberry pi", "ltspice", "verilog", "matlab",
        # Techniques & coursework
        "circuit design", "embedded system", "pcb", "microcontroller",
        "signal processing", "power system", "soldering",
        # Artifacts
        "breadboard", "oscilloscope", "hardware",
    ],
    "Civil & Environmental Engineering": [
        # Role identity — "civil" catches "civil engineering"
        "civil", "structural",
        # Tools
        "revit", "autocad", "staad", "arcgis",
        # Techniques & coursework
        "geotechnical", "surveying", "stormwater", "hydraulic",
        "concrete design", "soil mechanics", "site plan",
        # Artifacts & project types
        "infrastructure", "bridge", "construction management", "blueprint",
        "permitting", "load analysis",
    ],
    "Chemical & Biomedical Engineering": [
        # Role identity
        "chemical engineering", "biomedical engineering",
        # Tools & techniques
        "reactor design", "thermodynamic", "mass transfer", "aspen",
        "biomaterial", "polymer", "chemical synthesis", "process engineering",
        # Regulatory & quality
        "gmp", "fda", "validation",
        # Coursework terms
        "transport phenomena", "unit operation", "biofluid",
        "bioreactor", "pharmaceutical manufacturing",
    ],
    "Industrial & Systems Engineering": [
        # Role identity
        "industrial engineering", "systems engineering",
        # Methodologies — "lean" catches "lean manufacturing"
        "lean", "six sigma", "kaizen", "ergonomic",
        # Techniques
        "process improvement", "operations research", "simulation",
        "quality control", "work measurement", "time study",
        # Tools
        "arena simulation", "minitab", "value stream",
        # Artifacts
        "efficiency", "throughput", "capacity planning",
    ],

    # ── Business ─────────────────────────────────────────────────────────────
    "Finance & Accounting": [
        # Role identity
        "finance", "accounting", "investment banking", "equity research",
        # Tools & certifications
        "bloomberg", "excel modeling", "cpa", "cfa",
        # Techniques & artifacts
        "financial modeling", "valuation", "dcf", "audit",
        "corporate finance", "portfolio", "tax",
        # Domain terms
        "balance sheet", "cash flow", "hedge fund", "asset management",
    ],
    "Marketing & Advertising": [
        # Role identity — "marketing" catches "marketing intern"
        "marketing", "advertising", "brand",
        # Channels & tools
        "seo", "sem", "google analytics", "hubspot", "mailchimp",
        "social media", "email campaign", "content creation",
        # Techniques & artifacts
        "campaign", "consumer insight", "market research", "copywriting",
        "digital marketing", "influencer", "growth hacking",
    ],
    "Consulting & Strategy": [
        # Role identity
        "consulting", "strategy", "management consultant",
        # Firm names — substring matches "mckinsey fellow", "bain intern", etc.
        "mckinsey", "bain", "bcg", "deloitte", "accenture",
        # Artifacts & methods
        "case study", "deliverable", "slide deck", "client engagement",
        "benchmarking", "due diligence", "strategic recommendation",
        # Skills
        "stakeholder", "framework", "executive presentation",
    ],
    "Management & Operations": [
        # Role identity — "manager" catches "operations manager", "program manager"
        "manager", "operations", "project management",
        # Methodologies
        "agile", "scrum", "pmp", "okr",
        # Skills & artifacts
        "cross-functional", "roadmap", "budget", "kpi",
        "process optimization", "team lead", "workflow",
        # Broader org terms
        "execution", "resource allocation", "risk mitigation",
    ],
    "Economics & Public Policy": [
        # Role identity & field
        "economics", "econometric", "public policy",
        # Subfields — "macro" catches "macroeconomics"
        "macro", "micro", "behavioral economics",
        # Tools & techniques
        "stata", "regression", "instrumental variable", "panel data",
        # Artifacts & venues
        "policy analysis", "think tank", "policy brief", "welfare",
        # Certifications / programs
        "r programming", "regulatory", "congressional", "world bank",
    ],
    "Entrepreneurship & Innovation": [
        # Role identity
        "startup", "founder", "co-founder", "entrepreneur",
        # Funding stages & vehicles
        "venture", "seed funding", "series a", "angel investor",
        "y combinator", "incubator", "accelerator",
        # Artifacts & activities
        "pitch deck", "mvp", "product launch", "business model",
        "fundraising", "go-to-market", "traction",
    ],

    # ── Health & Life Sciences ────────────────────────────────────────────────
    "Healthcare & Clinical": [
        # Role identity & field
        "premed", "pre-med", "clinical", "medical",
        # Settings & activities
        "physician shadowing", "hospital", "clinical research",
        "healthcare administration", "patient",
        # Tools & certifications
        "ehr", "emr", "hipaa", "cpr certified",
        # Coursework
        "anatomy", "physiology", "pathophysiology", "diagnosis",
        "health policy", "medical terminology",
    ],
    "Life Sciences & Research": [
        # Role identity — "researcher" catches "research intern"
        "biology", "biochemistry", "wet lab", "bench research",
        # Techniques — substring matches lab protocol language
        "pcr", "gel electrophoresis", "cell culture", "western blot",
        "sequencing", "flow cytometry", "centrifuge",
        # Subfields
        "molecular biology", "genetics", "microbiology", "immunology",
        # Artifacts
        "lab notebook", "research poster", "assay",
    ],
    "Nursing & Patient Care": [
        # Role identity
        "nursing", "nurse", "rn", "lpn", "nclex",
        # Settings & rotations
        "clinical rotation", "icu", "med-surg", "bedside",
        # Activities & skills
        "patient care", "medication administration", "vital signs",
        "care plan", "patient assessment", "wound care",
        # Certifications & tools
        "bls certified", "emar", "charting",
    ],
    "Dental & Oral Health": [
        # Role identity
        "dental", "dentistry", "predental", "pre-dental",
        # Settings & activities
        "dental clinic", "dental shadowing", "dental assistant",
        "oral surgery", "orthodontic",
        # Techniques & tools
        "dental radiology", "radiograph", "extraction", "scaling",
        "prophylaxis", "composite restoration",
        # Coursework
        "oral health", "oral anatomy", "dental material",
    ],
    "Pharmacy & Pharmaceutical Science": [
        # Role identity
        "pharmacy", "pharmacist", "prepharmacy", "pharmd",
        # Settings & activities
        "clinical pharmacy", "drug dispensing", "compounding",
        "medication therapy", "patient counseling",
        # Techniques & coursework
        "pharmacology", "pharmacokinetic", "drug interaction",
        "therapeutic", "formulary",
        # Tools & certifications
        "immunization certified", "medication reconciliation", "mtm",
    ],
    "Veterinary & Animal Science": [
        # Role identity
        "veterinary", "vet tech", "prevet", "pre-vet", "zoology",
        # Settings & activities
        "animal hospital", "veterinary clinic", "clinical rotation",
        "small animal", "large animal", "livestock",
        # Techniques & coursework
        "animal care", "anesthesia", "surgery assist", "necropsy",
        "animal nutrition", "companion animal",
        # Tools
        "radiograph", "suture", "pathogen",
    ],
    "Physical Sciences & Math": [
        # Fields — "physics" catches "applied physics", "math" catches "mathematics"
        "physics", "math", "chemistry", "astronomy", "astrophysics",
        # Techniques & coursework
        "quantum", "spectroscopy", "differential equation",
        "linear algebra", "calculus", "theorem", "proof",
        # Tools & artifacts
        "matlab", "mathematica", "simulation", "lab report",
        # Subfields
        "particle", "optics", "condensed matter",
    ],

    # ── Social Sciences & Arts ────────────────────────────────────────────────
    "Social Sciences & Nonprofit": [
        # Role identity & fields
        "social work", "nonprofit", "sociology", "psychology",
        # Activities & skills
        "community outreach", "advocacy", "case management",
        "grant writing", "volunteer coordination", "program evaluation",
        # Settings
        "social services", "mental health", "crisis intervention",
        # Tools & certifications
        "501c3", "survey research", "qualitative", "irb",
    ],
    "Media & Communications": [
        # Role identity — "communicat" catches "communications" and "communicator"
        "communicat", "public relations", "media relations",
        # Artifacts & activities
        "press release", "editorial", "content creation", "storytelling",
        "broadcast", "podcast", "newsletter",
        # Tools & channels
        "pr agency", "cision", "media pitch", "messaging",
        # Skills
        "brand voice", "crisis communication", "speaking",
    ],
    "Design & Creative Arts": [
        # Role identity
        "graphic design", "visual design", "ux design", "ui design",
        # Tools — "figma" is highly diagnostic
        "figma", "photoshop", "illustrator", "indesign", "sketch",
        # Techniques & artifacts
        "typography", "illustration", "wireframe", "prototype",
        "brand identity", "design portfolio", "color theory",
        # Broader creative terms
        "layout", "mockup", "creative direction",
    ],
    "Performing Arts & Film": [
        # Role identity
        "theater", "acting", "performance", "directing",
        # Film-specific
        "film production", "cinematography", "screenplay", "documentary",
        # Stage & music
        "choreography", "stage management", "audition", "rehearsal",
        "music performance", "ensemble",
        # Artifacts
        "script", "reel", "production design",
    ],

    # ── Law & Government ──────────────────────────────────────────────────────
    "Law & Government": [
        # Role identity — "legal" catches "legal research", "legal intern"
        "legal", "law", "prelaw", "attorney", "paralegal",
        # Venues & activities
        "moot court", "law review", "litigation", "judicial",
        "law clerk", "legal brief", "contract",
        # Techniques & coursework
        "statute", "case law", "legal writing", "constitutional",
        "regulatory compliance", "appellate",
    ],
    "Criminal Justice & Public Safety": [
        # Role identity & field
        "criminal justice", "criminology", "forensic",
        # Settings & activities
        "law enforcement", "police", "correctional", "probation",
        "crime scene", "criminal investigation", "dispatch",
        # Coursework & certifications
        "criminal procedure", "victimology", "evidence",
        "public safety", "first responder", "background investigation",
    ],
    "Public Administration & Government": [
        # Role identity
        "public administration", "government", "municipal", "civic",
        # Settings & activities
        "federal agency", "state agency", "legislative",
        "policy implementation", "public sector",
        # Skills & artifacts
        "constituent", "budget analysis", "regulatory",
        "government relations", "foia", "procurement",
    ],

    # ── People & Education ────────────────────────────────────────────────────
    "Human Resources & People": [
        # Role identity — "recruit" catches "recruiting", "recruiter"
        "human resources", "recruit", "talent acquisition",
        # Activities & skills
        "employee relations", "onboarding", "performance management",
        "benefits administration", "compensation",
        # Tools & certifications
        "hris", "workday", "hr generalist", "shrm", "ats",
        # Broader people terms
        "workforce planning", "diversity", "culture",
    ],
    "Education & Human Development": [
        # Role identity — "teach" catches "teaching", "teacher", "taught"
        "teach", "educator", "tutor", "instructor",
        # Settings & activities
        "classroom", "curriculum development", "lesson plan",
        "k-12", "student development", "instructional design",
        # Tools & frameworks
        "pedagogy", "education technology", "canvas lms", "iep",
        # Broader terms
        "child development", "assessment", "learning outcome",
    ],
    "Religious Studies & Ministry": [
        # Role identity
        "ministry", "pastor", "chaplain", "seminary",
        # Activities & settings
        "theology", "pastoral care", "faith community", "church",
        "worship", "spiritual direction", "religious education",
        # Coursework & artifacts
        "scripture", "sermon", "congregation", "interfaith",
        "ethics", "liturgy",
    ],

    # ── Operations & Trades ───────────────────────────────────────────────────
    "Supply Chain & Logistics": [
        # Role identity — "supply chain" is highly diagnostic
        "supply chain", "logistics", "procurement", "sourcing",
        # Activities & skills
        "inventory management", "demand planning", "vendor management",
        "distribution", "freight", "warehouse",
        # Tools & certifications
        "sap", "erp", "oracle scm", "apics", "cpim",
        # Broader terms
        "fulfillment", "last mile", "trade compliance",
    ],
    "Real Estate & Construction": [
        # Role identity
        "real estate", "construction", "property", "cre",
        # Activities & settings
        "appraisal", "mortgage", "leasing", "asset management",
        "general contractor", "building inspection", "zoning",
        # Tools & certifications
        "argus", "mls", "bluebeam", "procore",
        # Coursework & artifacts
        "commercial real estate", "cap rate", "noi", "site selection",
    ],
    "Culinary Arts & Food Service": [
        # Role identity — "culinary" catches "culinary arts", "culinary intern"
        "culinary", "chef", "cook", "pastry",
        # Settings & activities
        "kitchen", "restaurant", "catering", "food service",
        "menu development", "food preparation", "banquet",
        # Tools & certifications
        "servsafe", "haccp", "food safety",
        # Techniques
        "knife skills", "plating", "recipe development",
    ],
    "Hospitality & Events": [
        # Role identity — "hospitality" catches "hospitality management"
        "hospitality", "hotel", "event planning", "resort",
        # Settings & activities
        "guest services", "front desk", "concierge", "banquet",
        "tourism", "conference management",
        # Tools & metrics
        "pms system", "revenue management", "occupancy", "opera pms",
        # Skills
        "customer service", "check-in", "catering coordination",
    ],

    # ── Specialized ───────────────────────────────────────────────────────────
    "Agriculture & Food Science": [
        # Role identity & fields
        "agriculture", "agronomy", "crop science", "food science",
        # Activities & settings
        "soil science", "livestock", "harvest", "irrigation",
        "precision agriculture", "pest management",
        # Tools & certifications
        "gis mapping", "usda", "extension service",
        # Coursework
        "sustainable farming", "plant biology", "animal husbandry",
        "agricultural research", "food processing",
    ],
    "Architecture & Urban Planning": [
        # Role identity — "architect" catches "architecture", "architect intern"
        "architect", "urban planning", "urban design",
        # Tools — highly diagnostic
        "revit", "rhino", "autocad", "sketchup", "grasshopper",
        # Techniques & coursework
        "architectural design", "studio", "spatial design",
        "building design", "site planning", "zoning",
        # Artifacts
        "rendering", "floor plan", "site analysis", "design critique",
    ],
    "Aviation & Transportation": [
        # Role identity
        "aviation", "pilot", "aeronautics", "air traffic",
        # Certifications & regulatory
        "faa", "private pilot", "instrument rating", "atpl",
        # Settings & activities
        "flight training", "aircraft", "airline operations",
        "dispatch", "aviation safety", "cockpit",
        # Broader transportation
        "aerospace logistics", "ground operations", "airport",
    ],
    "Fashion & Apparel": [
        # Role identity — "fashion" catches "fashion design", "fashion intern"
        "fashion", "apparel", "textile", "garment",
        # Activities & settings
        "styling", "merchandising", "retail buying", "collection",
        "fashion show", "lookbook", "trend forecasting",
        # Tools & techniques
        "clo3d", "flat sketch", "draping", "pattern making",
        # Broader terms
        "luxury goods", "visual merchandising", "production sourcing",
    ],
    "Foreign Languages & Linguistics": [
        # Fields — "linguist" catches "linguistics", "linguist"
        "linguist", "translation", "interpretation", "bilingual",
        # Languages — substring hits "native spanish speaker", "mandarin proficient"
        "spanish", "mandarin", "french", "arabic", "german", "japanese",
        # Skills & artifacts
        "language proficiency", "language acquisition", "localization",
        # Certifications & coursework
        "delf", "hsk", "jlpt", "fluent", "phonology",
    ],
    "Journalism & Broadcasting": [
        # Role identity
        "journalism", "reporter", "broadcast", "anchor",
        # Activities & artifacts
        "news writing", "investigative reporting", "editorial",
        "podcast production", "radio", "documentary",
        # Tools & platforms
        "ap style", "final cut", "adobe premiere", "multimedia",
        # Settings & skills
        "newsroom", "on-air", "copy editing", "story pitch",
    ],
    "Library & Information Science": [
        # Role identity
        "library", "librarian", "archivist", "cataloging",
        # Activities & artifacts
        "archival research", "metadata", "records management",
        "digital archives", "information retrieval", "reference",
        # Tools & standards
        "marc record", "dublin core", "dewey", "ebsco",
        # Skills & coursework
        "information curation", "collection development", "preservation",
    ],
    "Environmental & Sustainability": [
        # Role identity & fields
        "environmental", "sustainability", "ecology", "conservation",
        # Techniques & coursework
        "climate", "renewable energy", "carbon footprint",
        "life cycle assessment", "esg", "environmental impact",
        # Tools & certifications
        "arcgis", "leed", "epa",
        # Broader terms
        "green technology", "environmental policy", "biodiversity",
        "natural resources", "habitat restoration",
    ],

    # ── General / Biotech ─────────────────────────────────────────────────────
    "General": [],  # No field keywords — base rates apply everywhere
    "Biotech & Pharmaceutical": [
        "biotech", "pharmaceutical", "drug development", "clinical trials",
        "fda approval", "gmp", "molecular biology", "protein engineering",
        "gene therapy", "bioinformatics", "drug discovery",
        "crispr", "cell therapy", "assay development", "bioprocessing",
    ],
}


# ─── Cohort-Relative GPA Expectations ────────────────────────────────────────
# The GPA that is "competitive" for a recruiter in each field.
# Used by score_for_cohort() to make Smart cohort-relative:
#   3.5 in Communications (expected 2.8) → excellent Smart (ratio 1.25)
#   3.5 in Biochemistry   (expected 3.7) → below competitive Smart (ratio 0.95)
#
# Sources: company hiring FAQs, Wall Street Oasis, pre-med forums, Glassdoor,
#          LinkedIn recruiter surveys, ABA law school data, MBB case prep guides.

COHORT_EXPECTED_GPA: dict[str, float] = {
    # ── Tech & Engineering ────────────────────────────────────────────────────
    "Software Engineering & CS":              3.5,
    "Data Science & Analytics":               3.5,
    "Cybersecurity & IT":                     3.3,
    "Mechanical & Aerospace Engineering":     3.4,
    "Electrical & Computer Engineering":      3.5,
    "Civil & Environmental Engineering":      3.3,
    "Chemical & Biomedical Engineering":      3.6,
    "Industrial & Systems Engineering":       3.2,
    # ── Business ─────────────────────────────────────────────────────────────
    "Finance & Accounting":                   3.7,   # banks cut-off often 3.5–3.7
    "Marketing & Advertising":                3.0,
    "Consulting & Strategy":                  3.7,   # MBB screen at 3.5–3.7
    "Management & Operations":                3.0,
    "Economics & Public Policy":              3.5,
    "Entrepreneurship & Innovation":          2.8,   # execution > GPA
    # ── Health & Life Sciences ────────────────────────────────────────────────
    "Healthcare & Clinical":                  3.6,   # pre-med / clinical programs
    "Life Sciences & Research":               3.5,
    "Nursing & Patient Care":                 3.2,
    "Dental & Oral Health":                   3.6,
    "Pharmacy & Pharmaceutical Science":      3.3,
    "Veterinary & Animal Science":            3.4,
    "Physical Sciences & Math":               3.5,
    # ── Social Sciences & Arts ────────────────────────────────────────────────
    "Social Sciences & Nonprofit":            2.8,
    "Media & Communications":                 2.8,
    "Design & Creative Arts":                 2.8,   # portfolio > GPA
    "Performing Arts & Film":                 2.5,
    # ── Law & Government ──────────────────────────────────────────────────────
    "Law & Government":                       3.8,   # T14 / BigLaw very strict
    "Criminal Justice & Public Safety":       2.8,
    "Public Administration & Government":     3.0,
    # ── People & Education ────────────────────────────────────────────────────
    "Human Resources & People":               3.0,
    "Education & Human Development":          3.0,
    "Religious Studies & Ministry":           2.5,
    # ── Operations & Trades ───────────────────────────────────────────────────
    "Supply Chain & Logistics":               3.0,
    "Real Estate & Construction":             2.8,
    "Culinary Arts & Food Service":           2.5,
    "Hospitality & Events":                   2.5,
    # ── Specialized ───────────────────────────────────────────────────────────
    "Agriculture & Food Science":             3.0,
    "Architecture & Urban Planning":          3.3,
    "Aviation & Transportation":              3.0,
    "Fashion & Apparel":                      2.8,
    "Foreign Languages & Linguistics":        3.0,
    "Journalism & Broadcasting":              2.8,
    "Library & Information Science":          3.2,
    ...
    "Education & Teaching":                   3.0,
}


# ─── Activity Keywords for Grit Relevance ────────────────────────────────────
# Keywords that indicate field-relevant clubs, orgs, or activities.
# Used by score_for_cohort() to detect whether a student's leadership
# experience is relevant to the cohort being scored.
#
# Example: Biology major is president of Biology Club.
#   → Life Sciences Grit: "biology club" matches → full leadership credit
#   → Business Grit: "biology club" doesn't match → 35% leadership credit
#
# Keep lists to 8–14 terms. Single words cause false positives; prefer
# distinctive multi-word phrases where possible.

COHORT_ACTIVITY_KEYWORDS: dict[str, list[str]] = {
    # ── Tech & Engineering ────────────────────────────────────────────────────
    "Software Engineering & CS": [
        "hackathon", "open source", "coding competition", "tech club",
        "acm", "ieee computer", "software club", "developer club",
        "programming club", "computer science club", "startup weekend",
    ],
    "Data Science & Analytics": [
        "data science", "analytics club", "kaggle", "machine learning club",
        "statistics club", "data analytics", "ai club",
    ],
    "Cybersecurity & IT": [
        "cybersecurity", "security club", "ctf", "capture the flag",
        "information security", "ethical hacking", "tryhackme", "hackthebox",
    ],
    "Mechanical & Aerospace Engineering": [
        "robotics", "formula sae", "aerospace club", "mechanical engineering club",
        "sae international", "asme", "rocket club", "design competition",
    ],
    "Electrical & Computer Engineering": [
        "ieee", "circuit design club", "electrical engineering club",
        "ece club", "robotics", "hardware club", "pcb", "fpga club",
    ],
    "Civil & Environmental Engineering": [
        "asce", "civil engineering club", "concrete canoe", "steel bridge",
        "structural engineering", "construction management club",
    ],
    "Chemical & Biomedical Engineering": [
        "aiche", "chemical engineering club", "biomedical engineering club",
        "biochemical", "pharmaceutical club", "stem research",
    ],
    "Industrial & Systems Engineering": [
        "iise", "industrial engineering club", "lean", "operations research",
        "manufacturing club", "supply chain club",
    ],
    # ── Business ─────────────────────────────────────────────────────────────
    "Finance & Accounting": [
        "finance club", "investment club", "trading club", "cfa",
        "accounting club", "bloomberg", "wall street prep", "equity research",
        "portfolio management", "investment banking", "financial modeling",
    ],
    "Marketing & Advertising": [
        "marketing club", "advertising club", "ama", "brand", "digital marketing",
        "social media", "public relations club", "pr club", "marketing competition",
    ],
    "Consulting & Strategy": [
        "consulting club", "case competition", "strategy club",
        "business analytics club", "management consulting", "advisory club",
        "net impact", "business competition",
    ],
    "Management & Operations": [
        "student government", "business club", "project management",
        "entrepreneurship club", "operations", "leadership program",
    ],
    "Economics & Public Policy": [
        "economics club", "policy club", "model un", "debate team",
        "think tank", "government relations", "public policy",
    ],
    "Entrepreneurship & Innovation": [
        "startup", "entrepreneurship club", "venture", "founder",
        "innovation lab", "pitch competition", "business plan competition",
        "incubator", "accelerator",
    ],
    # ── Health & Life Sciences ────────────────────────────────────────────────
    "Healthcare & Clinical": [
        "hospital", "clinical volunteer", "pre-medical", "premed club",
        "health profession", "free clinic", "health club", "amsa",
        "snma", "patient care", "healthcare volunteer",
    ],
    "Life Sciences & Research": [
        "biology club", "biochemistry club", "research lab", "science club",
        "pre-health club", "biology", "research assistant",
        "molecular biology", "bench research",
    ],
    "Nursing & Patient Care": [
        "nursing club", "nsna", "patient", "hospital volunteer",
        "clinical", "healthcare volunteer", "nursing student",
    ],
    "Dental & Oral Health": [
        "predental", "dental club", "dentistry club", "dental shadowing",
        "dental assistant", "oral health", "asda",
    ],
    "Pharmacy & Pharmaceutical Science": [
        "pharmacy club", "prepharmacy", "pharmaceutical", "kphi", "aps",
        "drug", "medication", "clinical pharmacy",
    ],
    "Veterinary & Animal Science": [
        "veterinary club", "prevet", "animal hospital", "wildlife",
        "zoology club", "animal care", "scavma",
    ],
    "Physical Sciences & Math": [
        "physics club", "math club", "mathematics", "aps", "ams",
        "astronomy club", "quantum", "research", "mathematical",
    ],
    # ── Social Sciences & Arts ────────────────────────────────────────────────
    "Social Sciences & Nonprofit": [
        "community service", "nonprofit", "volunteer", "social work club",
        "advocacy", "outreach", "mental health club", "social justice",
        "habitat for humanity", "public service",
    ],
    "Media & Communications": [
        "student newspaper", "radio station", "communications club",
        "pr club", "media club", "press club", "broadcasting club",
        "journalism club", "public relations",
    ],
    "Design & Creative Arts": [
        "design club", "art club", "creative", "illustration club",
        "graphic design club", "portfolio", "studio arts", "aiga",
        "visual arts", "creative club",
    ],
    "Performing Arts & Film": [
        "theater", "film club", "acting", "dance club", "choir",
        "band", "drama club", "stage crew", "music ensemble", "orchestra",
    ],
    # ── Law & Government ──────────────────────────────────────────────────────
    "Law & Government": [
        "prelaw club", "moot court", "mock trial", "law club",
        "legal aid", "student bar association", "law review",
        "phi alpha delta", "political science club",
    ],
    "Criminal Justice & Public Safety": [
        "criminal justice club", "law enforcement", "criminology",
        "forensic club", "public safety", "criminal justice association",
    ],
    "Public Administration & Government": [
        "student government", "government club", "civic engagement",
        "political club", "model un", "public administration",
        "policy club", "city council", "public service",
    ],
    # ── People & Education ────────────────────────────────────────────────────
    "Human Resources & People": [
        "shrm", "hr club", "human resources club", "talent management",
        "recruiting club", "people analytics", "organizational leadership",
    ],
    "Education & Human Development": [
        "teaching", "tutoring", "literacy program", "education club",
        "teaching assistant", "mentor program", "kappa delta pi",
        "student teacher", "literacy volunteer",
    ],
    "Religious Studies & Ministry": [
        "church", "ministry", "faith community", "chapel program",
        "religious club", "chaplain", "worship team",
        "bible study", "youth group",
    ],
    # ── Operations & Trades ───────────────────────────────────────────────────
    "Supply Chain & Logistics": [
        "apics", "supply chain club", "logistics club", "scm",
        "operations club", "procurement club", "inventory management",
    ],
    "Real Estate & Construction": [
        "real estate club", "uli", "urban land institute",
        "construction management club", "property", "development club",
    ],
    "Culinary Arts & Food Service": [
        "culinary club", "cooking club", "restaurant", "food club",
        "chef", "catering", "food service", "hospitality club",
    ],
    "Hospitality & Events": [
        "hospitality club", "event planning club", "hotel management club",
        "tourism club", "conference planning", "guest service",
    ],
    # ── Specialized ───────────────────────────────────────────────────────────
    "Agriculture & Food Science": [
        "agriculture club", "ffa", "4h", "agronomy club", "crop science",
        "soil science club", "farm", "sustainable agriculture",
    ],
    "Architecture & Urban Planning": [
        "architecture club", "aias", "urban planning club",
        "architectural", "studio", "urban design club", "planning club",
    ],
    "Aviation & Transportation": [
        "aviation club", "pilot club", "flying club", "aerospace club",
        "air traffic", "airline club", "aeronautics",
    ],
    "Fashion & Apparel": [
        "fashion club", "design club", "apparel", "fashion design club",
        "textile", "styling club", "fashion show", "retail club",
    ],
    "Foreign Languages & Linguistics": [
        "language club", "linguistics club", "translation club",
        "bilingual", "spanish club", "mandarin club",
        "french club", "arabic club", "international club",
    ],
    "Journalism & Broadcasting": [
        "journalism club", "student newspaper", "radio station",
        "broadcast club", "editorial", "news club", "podcast club",
        "media production", "press",
    ],
    "Library & Information Science": [
        "library club", "information science club", "archival",
        "cataloging", "research club", "documentation",
    ],
    "Environmental & Sustainability": [
        "environmental club", "sustainability club", "climate action",
        "conservation club", "green club", "renewable energy club",
        "ecology club", "zero waste", "esg",
    ],
    # ── General / Biotech ─────────────────────────────────────────────────────
    "General":                  [],
    "Biotech & Pharmaceutical": [
        "biotech club", "pharmaceutical club", "drug discovery",
        "molecular biology club", "bioinformatics club", "bioengineering",
    ],
    # ── Legacy aliases ────────────────────────────────────────────────────────
    "Design & Creative":        [
        "design club", "art club", "creative", "illustration club",
        "graphic design club", "portfolio", "aiga",
    ],
    "Legal & Compliance":       [
        "prelaw club", "moot court", "mock trial", "law club",
        "legal aid", "student bar association",
    ],
    "Education & Teaching":     [
        "teaching", "tutoring", "education club", "teaching assistant",
        "mentor program", "literacy program",
    ],
}
