...
_VOICE_FORMATTING_BLOCK = """**Message formatting (use sparingly):** You can add rich text to your replies:
- **bold** for emphasis
...
_VOICE_SCORES_VIZ_INSTRUCTIONS = (
...
_VOICE_INLINE_VISUALS_BLOCK = """**Inline visuals (optional, sparingly):** The app can render small cards from exact markers. Prefer **one primary visual per reply** (plus short prose). Do not stack many markers in one message.
...
_COHORT_EXPERTISE_DEEP: dict[str, str] = {
