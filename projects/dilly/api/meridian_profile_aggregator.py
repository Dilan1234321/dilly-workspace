"""
Aggregate full Meridian profile from profile, audits, applications, achievements, etc.
Real-time aggregation — no new persisted document.
Used for GET /profile/meridian and GET /profile/public/{slug}/meridian.
"""
...
def aggregate_meridian_profile(email: str, for_recruiter: bool = False) -> dict[str, Any]:
    """
    Aggregate full Meridian profile for this user.
    ...
    privacy = profile.get("meridian_profile_privacy") or _default_privacy()
    visible_to_recruiters = profile.get("meridian_profile_visible_to_recruiters", True)
    ...
    data: dict[str, Any] = {
        ...
        "skills": skills,
        "privacy": privacy,
        "meridian_profile_visible_to_recruiters": visible_to_recruiters,
    }
