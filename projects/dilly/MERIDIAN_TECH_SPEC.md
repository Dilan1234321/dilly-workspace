...
## 3. LLM-Scoring Logic: The 'Relentless Generalist' Algorithm
...
2. **The Prompt Engineering Layer**:
   - We feed the LLM a 'Persona definition' of a 'Relentless Generalist' (defined as: high output, low supervision, multi-disciplinary execution).
