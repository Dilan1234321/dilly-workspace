...
# Paths (no beta cohort; Dilly uses only few-shot from training_data.json)
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
DB_PATH = os.path.join(SCRIPT_DIR, "dilly_database.json")
...
def display_dashboard(candidates):
    print("\n" + "="*60)
    print("      DILLY TALENT TERMINAL v1.0 - [ORCHESTRATOR MODE]")
    print("="*60)
