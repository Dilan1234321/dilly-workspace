...
- **Rubric:** One (or three: Pre-Health / Pre-Law / Humanities) markdown files that we pull from the internet + your notes. They define what “good” looks like for each track and what to count (e.g. clinical hours, BCPM, outcome-based leadership).
...
1. **Rubric first or few-shot first?**  
   - **Option A:** I draft one “research-backed rubric” (one file per track: Pre-Health, Pre-Law, Humanities) from public info + your SOUL/USER/INFERENCE_STANDARDS; you edit and we put it in the prompt.  
