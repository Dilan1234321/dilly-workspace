...
4. **Where should the rubric live?**  
   - In the repo (e.g. `projects/dilly/prompts/rubric_pre_health.md`) so you and OpenClaw can edit in place, or in a database/admin UI later?
