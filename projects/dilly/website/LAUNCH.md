...
4. **Configure:**
   ...
   - Deploy.
5. **Add your domain:** Project → Settings → Domains → Add `dilly-careers.com` and `www.dilly-careers.com`.
6. **In GoDaddy (DNS):**
...
7. Vercel will issue a free SSL certificate; your site will be `https://dilly-careers.com`.
...
4. Deploy.
5. **Domain:** Site settings → Domain management → Add custom domain → `dilly-careers.com` and `www.dilly-careers.com`.
...
2. Select repo, set **Build** to “None” (static), **Build output directory** to `projects/dilly/website` (or upload the folder).
3. Deploy.
4. **Add domain:** Pages project → Custom domains → Add `dilly-careers.com`.
...
- Open `https://dilly-careers.com` and `https://www.dilly-careers.com`.
- In your site, all links already use `https://dilly-careers.com` and `https://app.dilly-careers.com` for the app; no code change needed for the domain.
...
- [ ] Test https://dilly-careers.com and https://www.dilly-careers.com.
