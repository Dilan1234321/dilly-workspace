...
class MeridianV7_2_Med:
    """
    Meridian Engine V7.2: Medical Fraternity 'Pillar' Gold Standard
    ...
    def audit(self):
        ...
        # TRACK DETERMINATION
        track = "Pre-Health"
        tech_names = ["deng", "dilan", "mfugale", "zeltser", "rivers", "chiaravalloti", "pereira", "rina"]
        if any(x in self.file_path.lower() for x in tech_names) or major in ["Data Science", "Computer Science", "Finance", "Economics", "International Business"]:
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) > 1:
        engine = MeridianV7_2_Med(sys.argv[1])
