...
DILLY_DIR = os.path.dirname(SCRIPT_DIR)  # projects/dilly
WORKSPACE_ROOT = os.path.dirname(os.path.dirname(DILLY_DIR))
if WORKSPACE_ROOT not in sys.path:
    sys.path.insert(0, WORKSPACE_ROOT)

TRAINING_PATH = os.path.join(DILLY_DIR, "prompts", "training_data.json")
...
def main():
    ...
    for ex in examples:
        ...
        expected_track = ex.get("track", "Builder")
    ...
    # Report
    print("=" * 60)
    print("DILLY TRAINING DATA VERIFICATION")
