...
interface StateIconProps {
  ...
  className?: string;
  duration?: number;
  /** When provided, overrides auto-toggle for controlled usage */
  state?: boolean;
}

function useAutoToggle(interval: number, controlled?: boolean) {
  ...
  return controlled !== undefined ? controlled : on;
}
...
export function SuccessIcon({ size = 40, color = "currentColor", className, duration = 2200, state }: StateIconProps) {
  const done = useAutoToggle(duration, state);
  return (
...
export function MenuCloseIcon({ size = 40, color = "currentColor", className, duration = 2000, state }: StateIconProps) {
  const open = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function PlayPauseIcon({ size = 40, color = "currentColor", className, duration = 2400, state }: StateIconProps) {
  const playing = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function LockUnlockIcon({ size = 40, color = "currentColor", className, duration = 2600, state }: StateIconProps) {
  const unlocked = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function CopiedIcon({ size = 40, color = "currentColor", className, duration = 2200, state }: StateIconProps) {
  const copied = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function NotificationIcon({ size = 40, color = "currentColor", className, duration = 2800, state }: StateIconProps) {
  const notif = useAutoToggle(duration, state);
  return (
...
export function HeartIcon({ size = 40, color = "currentColor", className, duration = 2000, state }: StateIconProps) {
  const filled = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.path
...
export function DownloadDoneIcon({ size = 40, color = "currentColor", className, duration = 2400, state }: StateIconProps) {
  const done = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function SendIcon({ size = 40, color = "currentColor", className, duration = 2600, state }: StateIconProps) {
  const sent = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      <motion.g
        animate={sent
...
export function ToggleIcon({ size = 40, color = "currentColor", className, duration = 1800, state }: StateIconProps) {
  const on = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function EyeToggleIcon({ size = 40, color = "currentColor", className, duration = 2200, state }: StateIconProps) {
  const hidden = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function VolumeIcon({ size = 40, color = "currentColor", className, duration = 2400, state }: StateIconProps) {
  const muted = useAutoToggle(duration, state);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function AnimatedStateIconsDemo() {
  return (
    <div className="w-full max-w-[375px] mx-auto px-4 py-16">
      <div className="text-center mb-14">
        <h2 className="text-2xl font-bold tracking-tight text-foreground mb-2">
          Animated State Icons
        </h2>
        <p className="text-sm text-muted-foreground max-w-[375px] mx-auto">
