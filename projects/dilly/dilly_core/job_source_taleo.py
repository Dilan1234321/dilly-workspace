...
TALEO_COMPANIES: Dict[str, Tuple[str, str, Optional[str]]] = {
    ...
    # ── Added 2026-04-24: more Taleo tenants ──
    # Insurance
    "travelers":        ("Travelers Insurance", "Finance", None),
    "cna":              ("CNA Financial", "Finance", None),
    "hartford":         ("The Hartford", "Finance", None),
    "liberty-ins":      ("Liberty Mutual", "Finance", None),
    "nationwide-ins":   ("Nationwide Insurance", "Finance", None),
    "principal-financial":("Principal Financial", "Finance", None),
    "unum-group":       ("Unum Group", "Finance", None),
    "sun-life-us":      ("Sun Life US", "Finance", None),
    "transamerica":     ("Transamerica", "Finance", None),
    "great-american":   ("Great American Insurance", "Finance", None),
    "employers-holdings":("Employers Holdings", "Finance", None),
    "markel":           ("Markel Group", "Finance", None),
    "erie-indemnity":   ("Erie Indemnity", "Finance", None),
    "mercury-general":  ("Mercury General", "Finance", None),
    "donegal-group":    ("Donegal Group", "Finance", None),
    "kingsway-financial":("Kingsway Financial", "Finance", None),
    "employers-mutual": ("Employers Mutual", "Finance", None),
    "sura":             ("SURA Asset Management", "Finance", None),
    # Commercial real estate / REITs
    "simon-property":   ("Simon Property Group", "Finance", None),
    "prologis":         ("Prologis", "Finance", None),
    "duke-realty":      ("Duke Realty", "Finance", None),
    "welltower":        ("Welltower", "Healthcare", None),
    "ventas":           ("Ventas", "Healthcare", None),
    "brookfield-asset": ("Brookfield Asset Management", "Finance", None),
    "jll":              ("JLL", "Consulting", None),
    "cbre":             ("CBRE", "Consulting", None),
    "cushman-wakefield":("Cushman & Wakefield", "Consulting", None),
    "colliers":         ("Colliers International", "Consulting", None),
    "marcus-millichap": ("Marcus & Millichap", "Finance", None),
    "newmark":          ("Newmark", "Finance", None),
    # Restaurants / food service chains on Taleo
    "ihop":             ("IHOP", "Consumer", None),
    "denny":            ("Denny's", "Consumer", None),
    "cracker-barrel":   ("Cracker Barrel", "Consumer", None),
    "waffle-house":     ("Waffle House", "Consumer", None),
    "bob-evans":        ("Bob Evans", "Consumer", None),
    "golden-corral":    ("Golden Corral", "Consumer", None),
    "ryan-family":      ("Ryan Family Restaurants", "Consumer", None),
    "frisch":           ("Frisch's Restaurants", "Consumer", None),
    "steak-n-shake":    ("Steak 'n Shake", "Consumer", None),
    "huddle-house":     ("Huddle House", "Consumer", None),
    "big-boy":          ("Big Boy Restaurants", "Consumer", None),
    "perkins":          ("Perkins Restaurant", "Consumer", None),
    "village-inn":      ("Village Inn", "Consumer", None),
    "marie-callender":  ("Marie Callender's", "Consumer", None),
    "old-country-buffet":("Old Country Buffet", "Consumer", None),
    "hometown-buffet":  ("Hometown Buffet", "Consumer", None),
    # Hospitality / hotels
    "choice-hotels":    ("Choice Hotels", "Consumer", None),
    "best-western":     ("Best Western", "Consumer", None),
    "radisson":         ("Radisson Hotels", "Consumer", None),
    "wyndham-hotels":   ("Wyndham Hotels", "Consumer", None),
    "ihg-hotels":       ("IHG Hotels & Resorts", "Consumer", None),
    "accor-north-am":   ("Accor North America", "Consumer", None),
    "la-quinta":        ("La Quinta Inns", "Consumer", None),
    "motel-6":          ("Motel 6", "Consumer", None),
    "super-8":          ("Super 8", "Consumer", None),
    "days-inn":         ("Days Inn", "Consumer", None),
    "comfort-inn":      ("Comfort Inn", "Consumer", None),
    "holiday-inn":      ("Holiday Inn/IHG", "Consumer", None),
    "fairfield-marriott":("Fairfield by Marriott", "Consumer", None),
    "residence-inn":    ("Residence Inn", "Consumer", None),
    "courtyard-marriott":("Courtyard by Marriott", "Consumer", None),
    "sheraton":         ("Sheraton/Marriott", "Consumer", None),
    "westin":           ("Westin/Marriott", "Consumer", None),
    "w-hotels":         ("W Hotels/Marriott", "Consumer", None),
    "renaissance":      ("Renaissance Hotels/Marriott", "Consumer", None),
    "ritz-carlton":     ("Ritz-Carlton/Marriott", "Consumer", None),
    "st-regis":         ("St. Regis/Marriott", "Consumer", None),
    # Professional services / staffing on Taleo
    "huron-consulting":  ("Huron Consulting", "Consulting", None),
    "navigant":          ("Navigant Consulting", "Consulting", None),
    "grant-thornton":    ("Grant Thornton", "Consulting", None),
    "bdo":               ("BDO USA", "Consulting", None),
    "mcgladrey":         ("RSM US", "Consulting", None),
    "plante-moran":      ("Plante Moran", "Consulting", None),
    "moss-adams":        ("Moss Adams", "Consulting", None),
    "clifton-larson":    ("CliftonLarsonAllen", "Consulting", None),
    "aprio":             ("Aprio", "Consulting", None),
    "dixon-hughes":      ("Dixon Hughes Goodman", "Consulting", None),
    "eide-bailly":       ("Eide Bailly", "Consulting", None),
    "cbiz":              ("CBIZ", "Consulting", None),
    "mhm":               ("Mauldin & Jenkins", "Consulting", None),
    "cherry-bekaert":    ("Cherry Bekaert", "Consulting", None),
    "forvis":            ("Forvis Mazars", "Consulting", None),
    "cohnreznick":       ("CohnReznick", "Consulting", None),
    "citrin-cooperman":  ("Citrin Cooperman", "Consulting", None),
    "anchin":            ("Anchin", "Consulting", None),
    "friedman":          ("Friedman LLP", "Consulting", None),
    "berdon":            ("Berdon LLP", "Consulting", None),
    "pkf-odonnell":      ("PKF O'Connor Davies", "Consulting", None),
    "wiss":              ("Wiss & Company", "Consulting", None),
    "grassi":            ("Grassi Advisors", "Consulting", None),
    "rosenfield":        ("Rosenfield & Company", "Consulting", None),
}
