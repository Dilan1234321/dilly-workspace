...
# Cohort keywords and mappings live in scoring_cohort_keywords.py for readability.
from dilly_core.scoring_cohort_keywords import (
    COHORT_BUILD_KEYWORDS,
    COHORT_BUILD_ALIASES as _COHORT_BUILD_ALIASES,
    TRACK_TO_COHORT as _TRACK_TO_COHORT,
    MAJOR_TO_COHORT_OVERRIDE as _MAJOR_TO_COHORT_OVERRIDE,
)
